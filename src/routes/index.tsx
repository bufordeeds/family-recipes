...
import { ChefHat, Users, Clock, BookOpen } from 'lucide-react'
      ...
      <section className="px-6">
        <div className="bg-white rounded-2xl p-8 text-center shadow-sm">
          ...
          <p className="text-gray-600 mb-6">
            Start by adding your first family recipe or setting up your family.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              to="/family/setup"
              className="px-6 py-2 border border-amber-300 hover:border-amber-400 text-amber-700 font-medium rounded-xl transition-colors"
            >
              Set Up Family
            </Link>
          </div>
